...
export class Camera {
  constructor() {
    let count = (this.video = document.getElementById("video"));
  ...
  //     console.log("2 pose: ", pose["keypoints"][0]["x"]);
  //     this.drawResult(pose);
  //     if (pose["keypoints"][0]["x"] > 400) {
  //       result.innerHTML = "result: หันซ้าย";
  //       console.log("hello");
  //       return true;
  //     } else {
  //       result.innerHTML = "result: ปกติ";
  //       return false;
  //     }
  //   }
  // }
  ...
  drawResults(poses) {
    ...
    for (const pose of poses) {
      ...
      if (pose["keypoints"][0]["x"] > 400) {
        ...
        result.innerHTML = "result: หันขวา";
        console.log("hello");
      } else {
        result.innerHTML = "result: ปกติ";
        return false;
